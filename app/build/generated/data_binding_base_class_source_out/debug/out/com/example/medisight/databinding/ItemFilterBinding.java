...
public final class ItemFilterBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView itemFilter;

  private ItemFilterBinding(@NonNull ConstraintLayout rootView, @NonNull TextView itemFilter) {
  ...
  public static ItemFilterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.item_filter;
      TextView itemFilter = ViewBindings.findChildViewById(rootView, id);
      if (itemFilter == null) {
        break missingId;
      }

      return new ItemFilterBinding((ConstraintLayout) rootView, itemFilter);
    }
