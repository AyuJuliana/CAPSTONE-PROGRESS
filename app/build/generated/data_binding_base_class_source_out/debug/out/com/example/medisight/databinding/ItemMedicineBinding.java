...
public final class ItemMedicineBinding implements ViewBinding {
  ...
  private ItemMedicineBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialCardView materialCardView, @NonNull TextView medicineType) {
  ...
  public static ItemMedicineBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.medicine_type;
      TextView medicineType = ViewBindings.findChildViewById(rootView, id);
      if (medicineType == null) {
        break missingId;
      }

      return new ItemMedicineBinding((ConstraintLayout) rootView, materialCardView, medicineType);
    }
