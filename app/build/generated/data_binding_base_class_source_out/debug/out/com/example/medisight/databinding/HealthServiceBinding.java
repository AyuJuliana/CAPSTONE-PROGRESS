...
public final class HealthServiceBinding implements ViewBinding {
  @NonNull
  ...
  private HealthServiceBinding(@NonNull CoordinatorLayout rootView, @NonNull Chip chip1,
  ...
  @NonNull
  public static HealthServiceBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static HealthServiceBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.health_service, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static HealthServiceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HealthServiceBinding((CoordinatorLayout) rootView, chip1, chip2, chip3, chipGroup,
          recyclerView, searchBar, toolbarTitle, topAppBar);
    }
